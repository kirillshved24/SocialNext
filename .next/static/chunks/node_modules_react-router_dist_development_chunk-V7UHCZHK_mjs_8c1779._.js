(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_react-router_dist_development_chunk-V7UHCZHK_mjs_8c1779._.js", {

"[project]/node_modules/react-router/dist/development/chunk-V7UHCZHK.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/cookie/dist/index.js [app-client] (ecmascript)");
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_resolve_absolute_path__("node_modules/react-router/dist/development/chunk-V7UHCZHK.mjs")}`;
    }
};
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
    ...
    let { navigator: navigator2 } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useContext(NavigationContext);
...
function useFogOFWarDiscovery(router, manifest, routeModules, isSpaMode) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useEffect({
        "useFogOFWarDiscovery.useEffect": ()=>{
            ...
            document.body.querySelectorAll("a[data-discover], form[data-discover]").forEach({
                "useFogOFWarDiscovery.useEffect": (el)=>registerElement(el)
            }["useFogOFWarDiscovery.useEffect"]);
            fetchPatches();
            ...
            let observer = new MutationObserver({
                "useFogOFWarDiscovery.useEffect": (records)=>{
                    let elements = /* @__PURE__ */ new Set();
                    records.forEach({
                        "useFogOFWarDiscovery.useEffect": (r)=>{
                            [
                                r.target,
                                ...r.addedNodes
                            ].forEach({
                                "useFogOFWarDiscovery.useEffect": (node)=>{
                                    ...
                                    if (node.tagName !== "A") {
                                        node.querySelectorAll("a[data-discover], form[data-discover]").forEach({
                                            "useFogOFWarDiscovery.useEffect": (el)=>elements.add(el)
                                        }["useFogOFWarDiscovery.useEffect"]);
                                    }
                                }
                            }["useFogOFWarDiscovery.useEffect"]);
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Fragment, null, dataHrefs.map((href)=>/* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement("link", {
            key: href,
            rel: "prefetch",
            as: "fetch",
            href,
            ...linkProps
        })), moduleHrefs.map((href)=>/* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement("link", {
            key: href,
            rel: "modulepreload",
            href,
            ...linkProps
...
${matches.map({
                "Scripts.useMemo[initialScripts]": (match, index)=>`import * as route${index} from ${JSON.stringify(manifest.routes[match.route.id].module)};`
...
var createCookie = (name, cookieOptions = {})=>{
    ...
    return {
        ...
        async parse (cookieHeader, parseOptions) {
            ...
            let cookies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"])(cookieHeader, {
                ...options,
                ...parseOptions
            });
            if (name in cookies) {
        ...
        async serialize (value, serializeOptions) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serialize"])(name, value === "" ? "" : await encodeCookieValue(value, secrets), {
                ...options,
                ...serializeOptions
            });
        }
...
//# sourceMappingURL=node_modules_react-router_dist_development_chunk-V7UHCZHK_mjs_8c1779._.js.map